...
# strParam = "coderbyte"
# arr = []
# for i, value in enumerate(strParam):
#     arr.append(value)
# arr.reverse()
# strParam = ""
...
#     print(digits)
    ...
    # change the array into a integer and than add 1 and transform back to array

# int_result = int("".join(map(str, digits))) + 1
# digits = list(str(int_result))
# print(digits)
...
def QuestionsMarks(strParam):
    ...
    current = 0
    counter  = 0
    strParam = strParam.translate({ord(i): None for i in "abcdefghijklmnopqrstuvwxyz"})
    if len(strParam) < 5:
        return False
    l = list(strParam)
...
print(QuestionsMarks("a5c6c6a5???9asda"))